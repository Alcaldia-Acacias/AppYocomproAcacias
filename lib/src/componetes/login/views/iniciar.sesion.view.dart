...
class LoginFormPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: SingleChildScrollView(
            child: GetBuilder<LoginController>(builder: (state) {
          return Padding(
                  ...
                  children: <Widget>[
                    ...
                    InputForm(
                        ...
                        onEditingComplete: () => FocusScope.of(context)
                            .requestFocus(state.passwordFocoLogin)),
                    InputForm(
                    ...
                    if (Platform.isIOS) _appleSingInButton(),
                  ],
                )),
          );
        })),
  ...
  Widget _appleSingInButton() {
    return ButtonAppleSing(
           ...
           onTap: ()=>Get.find<LoginController>().loginApple(),
           );
    /*   return ButtonSocialSing(
